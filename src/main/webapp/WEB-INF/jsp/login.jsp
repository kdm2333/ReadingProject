...
<head>
 ...
 <body>
 ${msg}
<form action="<%=basePath%>login/login" class="pure-form pure-g" method="post">
      ...
      <div class="pure-group pure-input-1">
          <a href="<%=basePath%>login/toRegist">注册</a><%--
          <button  type="button" href="<%=basePath%>user/toRegist" class="pure-button pure-input-1 pure-button-primary">注册</button>--%>
